...
@interface Child_ChatViewControl01 ()

@end

@implementation Child_ChatViewControl01
...
{
    //创建textField
    _textField = [[UITextField alloc] initWithFrame:CGRectMake(30, 30, width - 60, 60)];
...
- (void)pressBtn01
{
    ...
    if ([temp length] != 0)
    {
        ...
        //创建数据视图
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(30, 90, width - 60, 120) style:UITableViewStylePlain];
        ...
        NSString *path02 = [NSString stringWithFormat:@"http://wx.yyeke.com/welcome2018/search/chatgroup/abstractly?index=学校群&key=%@",_textField.text];
