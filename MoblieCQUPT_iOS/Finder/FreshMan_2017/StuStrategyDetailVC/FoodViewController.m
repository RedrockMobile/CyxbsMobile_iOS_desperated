...
- (void)getData {
    ...
    [manager GET:@"https://wx.idsbllp.cn/welcome/2017/api/apiForGuide.php?RequestType=Cate" parameters:nil success:^(NSURLSessionDataTask * _Nonnull task, id _Nullable responseobject) {
