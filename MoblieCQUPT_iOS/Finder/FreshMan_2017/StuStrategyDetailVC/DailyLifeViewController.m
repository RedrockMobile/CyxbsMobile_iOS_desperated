...
- (void)getData {
    ...
    [manager GET:@"https://redrock.team/welcome/2017/api/apiForGuide.php?RequestType=LifeInNear" parameters:nil success:^(NSURLSessionDataTask * _Nonnull task, id _Nullable responseobject) {
