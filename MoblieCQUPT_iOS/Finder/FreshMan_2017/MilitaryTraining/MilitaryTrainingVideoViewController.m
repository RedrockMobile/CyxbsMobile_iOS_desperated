...
- (void)getPhotosData {
    ...
    [manager GET:@"https://wx.idsbllp.cn/welcome/2017/api/apiForGuide.php?RequestType=MilitaryTrainingPhoto" parameters:nil success:^(NSURLSessionDataTask * _Nonnull task, id _Nullable responseobject) {
...
- (void)getVideosData {
    ...
    [manager GET:@"https://wx.idsbllp.cn/welcome/2017/api/apiForGuide.php?RequestType=MilitaryTrainingVideo" parameters:nil success:^(NSURLSessionDataTask * _Nonnull task, id _Nullable responseobject) {
        NSDictionary *dic = responseobject;
