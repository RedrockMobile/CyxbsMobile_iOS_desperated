...
- (void)initButtons {
    ...
    for (int i = 0; i < 6; i++) {
        ...
        UILabel *label1 = [self labelWith:CGPointMake(x2 + 70, height + 45 * i) Text:BuildList[i]];
        ...
        [checkBox2 setTag:i];
        UILabel *label2 = [self labelWith:CGPointMake(x1 + 70, height + 45 * i) Text:PeriodList[i]];
