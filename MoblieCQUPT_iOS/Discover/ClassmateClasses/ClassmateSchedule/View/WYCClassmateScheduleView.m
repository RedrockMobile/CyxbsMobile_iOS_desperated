...
@interface WYCClassmateScheduleView()<UIScrollViewDelegate>
...
@property (nonatomic, strong) WYCClassmateScheduleShowDetailView *detailClassBookView;
...
@end
@implementation WYCClassmateScheduleView
