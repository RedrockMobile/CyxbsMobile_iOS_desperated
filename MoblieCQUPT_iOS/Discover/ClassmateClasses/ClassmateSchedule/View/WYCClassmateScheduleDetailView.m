//
//  WYCClassmateScheduleDetailView.m
//  MoblieCQUPT_iOS
//
...
@interface WYCClassmateScheduleDetailView()
...
@end
@implementation WYCClassmateScheduleDetailView
+(WYCClassmateScheduleDetailView *)initViewFromXib{
    NSArray* nibView =  [[NSBundle mainBundle] loadNibNamed:@"WYCClassmateScheduleDetailView" owner:nil options:nil];
