//
//  WYCClassmateScheduleShowDetailView.m
//  MoblieCQUPT_iOS
//
...
@interface WYCClassmateScheduleShowDetailView()<UIScrollViewDelegate>
...
@implementation WYCClassmateScheduleShowDetailView
...
- (void)initViewWithArray:(NSArray *)array{
    ...
    for (int i = 0; i < array.count; i++) {
        ...
        WYCClassmateScheduleDetailView *view = [WYCClassmateScheduleDetailView initViewFromXib];
