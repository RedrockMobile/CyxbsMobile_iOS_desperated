...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (!self.isMyJoin) {
        ...
        [cell.bgImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"https://cyxbsmobile.redrock.team/cyxbsMobile/Public/photo/%@",_data[indexPath.item][@"img"][@"img_small_src"]]]];
    }
