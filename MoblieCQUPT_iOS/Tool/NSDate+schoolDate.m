...
//
    NSInteger weekNum = week.integerValue;
    NSInteger dayNum = weekday.integerValue;
    //从字符串转换日期
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
    ...
    NSDate *examDate = [startDate dateByAddingTimeInterval: 60 * 60 * 24 * ((weekNum - 1) * 7 + dayNum - 1)];
