...
- (void)awakeFromNib {
    ...
    self.Content.textColor=RGB(136, 136, 136);
...
//    OneTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identify];
//    if (!cell) {
//        cell = [[OneTableViewCell alloc]initWithStyle:UITableViewCellStyleValue2 reuseIdentifier:identify];
//    }
//    return cell;
//    
//}
