...
-(void)Data{
    ...
    NSError *error = nil;
    NSString *txtpath1 = [[NSBundle mainBundle] pathForResource:@"新生群" ofType:@"txt"];
    NSString *txtpath2 = [[NSBundle mainBundle] pathForResource:@"老乡群" ofType:@"txt"];
    NSString *XinSheng = [NSString stringWithContentsOfFile:txtpath1 encoding:NSUTF8StringEncoding error:&error];
    NSString *LaoXiang = [NSString stringWithContentsOfFile:txtpath2 encoding:NSUTF8StringEncoding error:&error];
    self.Content = [[NSArray alloc]init];
    self.Name = [[NSArray alloc]init];
    NSString *Name1 = @"各学院新生群：";
    NSString *Name2 = @"老乡群：";
    self.Name = @[Name1,Name2];
    self.Content = @[XinSheng,LaoXiang];
