...
#define url @"http://hongyan.cqupt.edu.cn/cyxbsMobile/index.php/Home/WelcomeFreshman/daylyLife"
...
-(void)download{
    ...
    [manger POST:url parameters:@{@"page": @0, @"size": @19} success:^(AFHTTPRequestOperation *operation, id responseObject) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return rect1.size.height+rect2.size.height +100;
}
