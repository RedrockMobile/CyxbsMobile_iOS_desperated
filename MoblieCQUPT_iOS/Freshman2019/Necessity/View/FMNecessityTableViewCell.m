...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier: reuseIdentifier]){
        ...
        self.hidden = NO;
        UIImageView *bkg = [[UIImageView alloc]initWithFrame:CGRectMake(15*WIDTH, 0, 345*WIDTH, 52*HEIGHT)];
        ...
        btn1.frame = CGRectMake(30*WIDTH, 17*HEIGHT, 16*WIDTH, 16*HEIGHT);
        [btn1 setImage:[UIImage imageNamed:@"蓝框"] forState:UIControlStateNormal];
        self.btn1 = btn1;
        
        UIButton *btn3 = [[UIButton alloc] init];
        btn3.frame = CGRectMake(30*WIDTH, 17*HEIGHT, 16*WIDTH, 16*HEIGHT);
        [btn3 setImage:[UIImage imageNamed:@"蓝框"] forState:UIControlStateNormal];
        self.btn3 = btn3;
        
        UILabel *label = [[UILabel alloc] init];
        label.frame = CGRectMake(63*WIDTH, 17*HEIGHT, width-150, 16*HEIGHT);
        label.textColor = RGBColor(51, 51, 51, 0.3);
        label.font = [UIFont systemFontOfSize:14 weight:UIFontWeightThin];
        [self.contentView addSubview: label];
        self.label = label;
        
        UILabel *detailLabel = [[UILabel alloc]initWithFrame:CGRectMake(63*WIDTH, 48*HEIGHT, 269*WIDTH, 0)];
        detailLabel.font = [UIFont systemFontOfSize:13 weight:UIFontWeightLight];
        detailLabel.numberOfLines = 0;
        detailLabel.textColor = RGBColor(102, 102, 102, 1);
        [self.contentView addSubview:detailLabel];
        self.detailLabel = detailLabel;
        
        
        UIButton *btn2 = [[UIButton alloc] initWithFrame:CGRectMake(332*WIDTH, 17*HEIGHT, 14*WIDTH, 19*HEIGHT)];
...
- (void)setDLNModel:(DLNecessityModel *)DLNModel{
    ...
    if (DLNModel.isShowMore){
        ...
        self.bkg.frame = CGRectMake(15*WIDTH, 0, 345*WIDTH, 65*HEIGHT+height);
        _detailLabel.frame = CGRectMake(63*WIDTH, 48*HEIGHT, 269*WIDTH, height);
        _btn2.selected = YES;
    }
    else{
        self.bkg.image = [UIImage imageNamed:@"白底"];
        self.bkg.frame = CGRectMake(15*WIDTH, 0, 345*WIDTH, 52*HEIGHT);
        _detailLabel.frame = CGRectMake(63*WIDTH, 48*HEIGHT, 269*WIDTH, 0);
